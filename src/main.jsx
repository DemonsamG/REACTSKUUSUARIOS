...
import RoleAppPrivileges from './pages/RoleAppPrivileges.jsx';
import RoleGroups from './pages/RoleGroups.jsx';
// --- FIN DE AÑADIR ---
        ...
        <Routes>
          ...
          <Route path="/" element={<ShellLayout />}>
           {/* Rutas hijas que se renderizarán dentro del <Outlet /> */}
            ...
            <Route path="role-app-privileges" element={<RoleAppPrivileges />} />
